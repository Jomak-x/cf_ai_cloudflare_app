/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: dd315f8f35ede05f6eaeff563f5053c9)
// Runtime types generated with workerd@1.20251217.0 2025-10-08 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LaunchSessionDurableObject";
	}
	interface Env {
		LAUNCH_SESSIONS: DurableObjectNamespace<import("./src/index").LaunchSessionDurableObject>;
		AI: Ai;
		ASSETS: Fetcher;
		LAUNCH_BRIEF_WORKFLOW: Workflow<Parameters<import("./src/index").LaunchBriefWorkflow['run']>[0]['payload']>;
	}
}
